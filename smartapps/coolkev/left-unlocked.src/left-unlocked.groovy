...
preferences {
	...
	section("And notify me if it's open for more than this many stupid minutes (default 10)") {
		input "openThreshold", "number", description: "Number of minutes", required: false
	}
    
	section("Also, do this crap every many minutes (default 10)") {
		input "crapMinutes", "number", description: "Crap Minutes", required: false
	}
}
